...
-- Local var for conciseness
local opts = { noremap = true, silent = true }

-- Delete single char without copying it
...
vim.keymap.set('n', '<leader>se', '<C-w>=', opts) --make split 
...
vim.keymap.set('n', '<leader>lw', '<cmdset wrap!<CR>', opts)
